  ...
  return (
    <TooltipProvider delayDuration={0}>
      ...
      <motion.aside
        ...
        className={`fixed inset-y-0 left-0 z-40 flex flex-col bg-background/80 backdrop-blur-2xl border-r border-border/20 shadow-2xl overflow-hidden transition-colors duration-300 ${isMobileOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
          }`}
      >
