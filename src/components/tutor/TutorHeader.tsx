  ...
  return (
    <header className="z-30 flex items-center justify-between shrink-0 pointer-events-auto mx-4 mt-4 mb-2 px-4 py-3 border border-border/80 bg-card/65 backdrop-blur-xl rounded-[24px] shadow-sm lg:mx-0 lg:mt-0 lg:mb-0 lg:w-full lg:h-16 lg:px-6 lg:py-4 lg:border-t-0 lg:border-x-0 lg:border-b lg:border-border/65 lg:bg-background/80 lg:rounded-none lg:shadow-none">
      ...
      <div className="flex items-center gap-3 lg:hidden">
        ...
        <button 
          onClick={toggleTheme}
          className="w-10 h-10 rounded-full flex items-center justify-center bg-card border border-border/80 shadow-sm hover:bg-secondary/50 transition-all hover:scale-105 active:scale-95 group cursor-pointer"
        ...
        {/* User Profile Button */}
        <Link to="/profile" className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center shadow-md hover:scale-105 active:scale-95 transition-all">
      ...
      <div className="hidden lg:flex items-center gap-3">
        ...
        <button 
          onClick={toggleTheme}
          className="relative w-10 h-10 rounded-full flex items-center justify-center bg-card border border-border/80 shadow-sm hover:bg-secondary/50 transition-all hover:scale-105 active:scale-95 group cursor-pointer"
          title={theme === "dark" ? "Switch to Light Mode" : "Switch to Dark Mode"}
        >
          {theme === "dark" ? (
        ...
        {/* User Profile Button */}
        <Link to="/profile" className="w-10 h-10 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center shadow-sm cursor-pointer border border-sky-200 transition-all hover:scale-105 active:scale-95">
