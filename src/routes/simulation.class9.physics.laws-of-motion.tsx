  ...
  return (
    <>
      ...
      <div className="mt-4">
        ...
        <LawGraphPanel
          samples={apiTrajectory || canvasSamples}
          series={[
            { title: "Velocity vs t", color: "#7dd3fc", unit: "m/s", get: (s) => s.v },
            { title: "Acceleration vs t", color: "#a78bfa", unit: "m/s²", get: (s) => s.a },
      ...
      <div className="shrink-0">
        {tab === "first" && (
          <>
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>
                An object continues in its state of rest or uniform motion unless acted upon by an
                external force. When the bus brakes suddenly, the object on top has no horizontal
                force acting on it instantly, so it keeps moving forward.
              </p>
              <p>
                Friction (μ) is what eventually slows the sliding object down. Heavier objects (more
                mass) carry more <em>momentum</em> and resist change more strongly.
              </p>
            </div>
          </>
        )}
        {tab === "second" && (
          <>
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <p>
                Try doubling the force — acceleration doubles. Double the mass and acceleration
                halves. The pink arrow shows force, blue shows acceleration, red shows current
                velocity.
              </p>
            </div>
          </>
        ...
        {tab === "third" && (
          <>
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>
                For every action there is an equal and opposite reaction. When object A pushes B, B
                pushes A back with the same force in the opposite direction.
              </p>
              <p>
                Even though forces are equal, accelerations are not — the lighter object accelerates
                more (a = F/m). This is why a rocket's tiny exhaust mass moving fast can push a huge
                rocket forward.
              </p>
            </div>
          </>
